(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("098ab02e-e6b7-4258-b480-c63e013dc301");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '098ab02e-e6b7-4258-b480-c63e013dc301' but no matching script tag was found.")
        }
