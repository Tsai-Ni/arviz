(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("45315065-9ee2-4321-96f5-c9a992213596");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '45315065-9ee2-4321-96f5-c9a992213596' but no matching script tag was found.")
        }
